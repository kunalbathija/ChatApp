...
import com.kunal.chatapp.Adapter.MessageAdapter;
import com.kunal.chatapp.Fragments.APIService;
import com.kunal.chatapp.Model.Chat;
import com.kunal.chatapp.Model.User;
import com.kunal.chatapp.Notifications.Client;
import com.kunal.chatapp.Notifications.Data;
import com.kunal.chatapp.Notifications.MyResponse;
import com.kunal.chatapp.Notifications.Sender;
import com.kunal.chatapp.Notifications.Token;
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity.this,"You can't lol", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
